...
import {
  ...
  getScannerTransactionUrl,
  getScannerBlockNumberUrl,
  getScannerBlockCountdownUrl,
} from 'utils/bscscan'
...
describe('getBscScanAddressUrl', () => {
  it.each([
    ...
    expect(getScannerAddressUrl(address)).toEqual(expected)
  })
})
...
describe('getBscScanTransactionUrl', () => {
  it.each([
    ...
    expect(getScannerTransactionUrl(tx)).toEqual(expected)
  })
})
...
describe('getBscScanBlockNumberUrl', () => {
  it.each([
    ...
    expect(getScannerBlockNumberUrl(block)).toEqual(expected)
  })
})
...
describe('getBscScanBlockCountdownUrl', () => {
  it.each([
    ...
    expect(getScannerBlockCountdownUrl(block)).toEqual(expected)
  })
})
