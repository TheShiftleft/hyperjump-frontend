import { Currency, Token, ChainId } from '@hyperjump-defi/sdk'
...
import { useAllTokens, useToken, useBridgeTokens } from '../../hooks/Tokens'
import { useSelectedListInfo, TokenAddressMap, WrappedTokenInfo } from '../../state/lists/hooks'
...
export function BridgeCurrencySearch({
  ...
  const allTokens = useMemo(() => {
    return (bridgeTokensOnly ? _networkTokens[0] : _allTokens)
  }, [bridgeTokensOnly, _allTokens, _networkTokens])
