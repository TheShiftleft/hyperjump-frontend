...
import { formattedNum, formattedPercent, getPoolLink, getSwapLink, localNumber } from '../../../utils/analytics'
import { useTokenData, useTokenTransactions, useTokenPairs } from '../../../contexts/Analytics/TokenData'
import { useColor } from '../../../hooks'
import CopyHelper from '../components/Copy'
import { useDataForList } from '../../../contexts/Analytics/PairData'
import Warning from '../components/Warning'
import { usePathDismissed, useSavedTokens } from '../../../contexts/Analytics/LocalStorage'
import { TYPE, ThemedBackground, Hover, PageWrapper, ContentWrapper, StyledIcon } from '../components'
      ...
      <ContentWrapper>
        <RowBetween style={{ flexWrap: 'wrap', alingItems: 'start' }}>
          <AutoRow align="flex-end" style={{ width: 'fit-content' }}>
            <TYPE.body>
              <BasicLink to="/analytics/tokens">{'Tokens '}</BasicLink>→ {symbol}
              {'  '}
            </TYPE.body>
            <Link
