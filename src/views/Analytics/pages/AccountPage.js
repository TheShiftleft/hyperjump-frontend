...
import { useUserTransactions, useUserPositions } from '../../../contexts/Analytics/User'
...
import { TYPE, PageWrapper, ContentWrapper, StyledIcon } from '../components'
import DoubleTokenLogo from '../components/DoubleLogo'
import Link, { BasicLink }  from '../components/Link'
import { FEE_WARNING_TOKENS } from '../../../config/constants/analytics'
  ...
  return (
    <PageWrapper>
      <ContentWrapper>
        <RowBetween>
          <TYPE.body>
            <BasicLink to="/analytics/accounts">{'Accounts '}</BasicLink>→{' '}
        ...
        <DashboardWrapper>
          ...
          >
            <AutoRow gap="20px">
              ...
              <AutoColumn gap="8px">
                <TYPE.header fontSize={24}>{transactionCount || '-'}</TYPE.header>
