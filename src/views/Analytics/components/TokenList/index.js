...
import { OVERVIEW_TOKEN_BLACKLIST } from '../../../../config/constants/analytics'
      ...
      <DashGrid style={{ height: '48px' }} focus >
        <DataText area="name" fontWeight="500">
          <Row>
            ...
            <TokenLogo address={item.id} size='24px' sizeraw={24} />
            <CustomLink style={{ marginLeft: '16px', whiteSpace: 'nowrap' }} to={`/analytics/token/${item.id}`}>
              <FormattedName
