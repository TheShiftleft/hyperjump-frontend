...
export const ButtonLight = styled(Base)`
  background-color: ${({ color, theme }) => (color ? transparentize(0.9, color) : transparentize(0.9, theme.colors.primary1))};
  color: ${({ color, theme }) => (color ? darken(0.1, color) : theme.colors.primary1)};
  ...
  color ? transparentize(0.8, color) : transparentize(0.8, theme.colors.primary1)};
  }
`
...
export const ButtonDark = styled(Base)`
  ...
  :hover {
    background-color: ${({ color, theme }) => (color ? darken(0.1, color) : darken(0.1, theme.colors.primary1))};
  }
`
...
export const OptionButton = styled.div`
  ...
  background-color: ${({ active, theme }) => active && theme.colors.bg3};
